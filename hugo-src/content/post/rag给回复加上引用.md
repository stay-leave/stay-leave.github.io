...
效果展示：
![直接挂载 chunk 元数据作为引文](/b_images/2024_12_6/1.png)
...
效果展示：
![提示词方法生成的引用效果](/b_images/2024_12_6/2.png)
...
效果展示：
![文档级函数调用引用效果](/b_images/2024_12_6/3.png)

### 片段级别的引用

与上述相比，增加了一个数据组织结构。要求引用的是片段。
首先看看检索到的文档内容：
![检索到的原始文段](/b_images/2024_12_6/4.png)

这是个文段，里面有很多条句子。
经过句子级别引用后的结果，可以看到大模型自己识别出了对回答问题有益的片段。
![片段级引用后的结果](/b_images/2024_12_6/5.png)
...
效果展示：
![生成后处理添加引用效果](/b_images/2024_12_6/6.png)
...
效果展示：
![相似度后挂载引用效果](/b_images/2024_12_6/7.png)
